...
public class FormulaParser {
	...
	private FormulaMacro parseDefaultMacro(String[] rawLines) {
		...
		do {
			i++;
			if(i >= rawLines.length) break; //Zabezpieczenie przed ï¿½rednikiem na koï¿½cu pliku w FORMULI
			rawLine = rawLines[i];
...
//					i++;
		...
		throw new RuntimeException("Bï¿½ï¿½d zagnieï¿½dzenia macro");
	}
